...
$col .= $server->isRenewal ? '`matk` AS matk, `equip_level_min` AS equip_level_min , `equip_level_max` AS equip_level_max ,': '`equip_level` AS equip_level_min,';
$col .= 'equip_script, unequip_script, origin_table, ';
$col .= "$shopTable.cost, $shopTable.id AS shop_item_id, atk AS atk ";
